...
const TipoSolicitud = ({usuarioLogeado})=>{
    ...
    const listarSolicitudes = async (search)=>{
        try {
            const resultSet = await axiosPrivate.post('/tipo-solicitud/listar', {pagSiguiente : pagSiguiente, cantPorPag : cantPorPag, search});
    ...
    return (
        <div className="container py-3">
            ...
            <TablePagination
                            ...
                            <div className="btn-group" role="group">
                                ...
                                <button type="button" className="btn btn-danger" onClick={
                                    ()=>{
                                        ...
                                        if(resp) eliminarRegistro(value.idtiposolicitud);
                                    }
                                }>
                ...
                placeHolderSearch="Buscar nombre de solicitud"
                eliminar={{
                    url : '/tipo-solicitud/eliminar'
                }}
            />
            </main>
            <Footer/>
